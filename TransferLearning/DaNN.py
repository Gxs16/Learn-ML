...
from paddle.vision.transforms import Compose, Grayscale, RandomHorizontalFlip, RandomRotation, Resize, ToTensor, BaseTransform
...
class Canny(BaseTransform):
    ...
    def _apply_image(self, img):
        Canny_img = lambda img: cv2.Canny(np.array(img), self.low, self.high)
        return Canny_img(img)
